...
function openModal(cardIndex) {
  ...
  switch (cardIndex) {
      case 1:
          ...
          modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Front-end-bricool/')");
          break;
      ...
      case 2:
        ...
        modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/My-First-Design-With-Tailwind-css/')");
      ...
      case 3:
          ...
          modalTitle.innerText = "Swipy";
            modalDescription.innerText = "Static Website";
          modalButton.setAttribute("onclick", "openLink('https://joyful-chimera-2b2203.netlify.app/')");
      ...
      case 4:
        ...
        modalTitle.innerText = "Rework Web Site Ebf";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://ebf.netlify.app/index.html')");
      ...
      case 5:
        ...
        modalButton.setAttribute("onclick", "openLink('https://3byoussef.netlify.app/')");
      ...
      case 6:
        ...
        modalTitle.innerText = "Flex it";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Flex-It-Responsive-web-site-with-dark-mode-and-light-mode/#')");
      ...
      case 7:
        ...
        modalTitle.innerText = "E-commerce Web Site";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/web-site-store/')");
      ...
      case 8:
        ...
        modalTitle.innerText = "Photographer Web Site";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/My-first-boostrap-web-site/')");
      ...
      case 9:
        ...
        modalTitle.innerText = "Rework Trello";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Trello-Responsive/')");
      ...
      case 10:
        ...
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Image-Editor/')");
      ...
      case 11:
        ...
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Word-Scramble-Game/')");
      ...
      case 12:
        ...
        modalTitle.innerText = "tic tac toe game with ai";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Tic-Tac-Toe-Javascript/')");
      ...
      case 13:
        ...
        modalTitle.innerText = "rock paper scissors Game";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Rock-Scissors-Paper-Game/')");
      ...
      case 14:
        ...
        modalTitle.innerText = "Memory Game";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Memory-Game/')");
      ...
      case 15:
        ...
        modalTitle.innerText = "Quiz Game";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Quiz-Game/')");
      ...
      case 16:
        ...
        modalTitle.innerText = "To Uppercase or to lower case";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Convert-Case-/')");
      ...
      case 17:
        ...
        modalTitle.innerText = "crud";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/CRUDS-project/')");
      ...
      case 18:
        ...
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/COUNTRY/')");
        break;
      case 19:
        modalImage.src = "projects/12.jpg";
        modalTitle.innerText = "Random memes";
          modalDescription.innerText = "app";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/Memes-app/')");
      ...
      case 22:
        ...
        modalTitle.innerText = "san fransisco";
          modalDescription.innerText = "Static Website";
        modalButton.setAttribute("onclick", "openLink('https://youssef3b.github.io/My-First-Responsive-web-site/')");
